...
import static org.conscrypt.TestUtils.readPrivateKeyPemFile;
...
public class SSLSocketTest {
    ...
    public void test_SSLSocket_handshake_For_ShangMi() throws Exception {
        ...
        Thread serverThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    SSLServerSocket serverSocket = getServerSslSocketForShangMi();
        ...
        final SSLSocket client = getClientSslSocketForShangMi();
    ...
    private static SSLSocket getClientSslSocketForShangMi()throws Exception{
        ...
        SSLSocket sslSocket = (SSLSocket)socketFactory.createSocket("127.0.0.1", 8888);
        return sslSocket;
    }
    ...
    private static SSLServerSocket getServerSslSocketForShangMi()throws Exception{
        ...
        PrivateKey privateKey = readPrivateKeyPemFile("sm2-private.key");
        ...
        return (SSLServerSocket)socketFactory.createServerSocket(8888);
    }
    ...
    public void test_SSLSocket_CertVerify_For_ShangMi() throws Exception {
        ...
        Thread serverThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    SSLServerSocketFactory socketFactory = sslContext.getServerSocketFactory();
                    SSLServerSocket serverSocket = (SSLServerSocket)socketFactory.createServerSocket(9999);
                    serverSocket.setEnabledCipherSuites(enabledCipherSuites);
                    serverSocket.setEnabledProtocols(new String[]{"TLSv1.3"});
                    while (true){
                        SSLSocket sslSocket = (SSLSocket)serverSocket.accept();
        ...
        SSLContext sslContext = SSLContext.getInstance("TLSv1.3", Conscrypt.newProvider());
        KeyManagerFactory kmf = KeyManagerFactory.getInstance("SunX509");
        kmf.init(clientKeyStore, EMPTY_PASSWORD);
        KeyManager[] kms = kmf.getKeyManagers();
        ...
        sslContext.init(kms, tms, new SecureRandom());
        SSLSocketFactory socketFactory = sslContext.getSocketFactory();
        SSLSocket client = (SSLSocket)socketFactory.createSocket("127.0.0.1", 9999);
        client.setEnabledCipherSuites(enabledCipherSuites);
        client.setEnabledProtocols(new String[]{"TLSv1.3"});
        client.startHandshake();
        OutputStream outputStream = client.getOutputStream();
    ...
    private static KeyStore buildKeyStoreForShangMi(String cert,String caCert,String key)throws Exception{
        ...
        PrivateKey privateKey = readPrivateKeyPemFile(key);
