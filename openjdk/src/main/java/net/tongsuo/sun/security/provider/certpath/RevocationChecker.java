...
import net.tongsuo.sun.security.util.CollectionUtil;
...
import net.tongsuo.sun.security.x509.AuthorityInfoAccessExtension;
...
import net.tongsuo.sun.security.x509.X509CRLEntryImpl;
import net.tongsuo.sun.security.x509.X509CertImpl;
import net.tongsuo.java.util.HexFormat;
                ...
                new PrivilegedAction<RevocationProperties>() {
                    public RevocationProperties run() {
                        ...
                        String onlyEE = Security.getProperty(
                                "net.tongsuo.pkix.onlyCheckRevocationOfEECert");
                        ...
                        rp.crlDPEnabled
                                = Boolean.getBoolean("net.tongsuo.pkix.enableCRLDP");
                        rp.ocspNonce
