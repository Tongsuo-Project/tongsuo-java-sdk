...
import net.tongsuo.sun.security.util.Cache;
...
class URICertStore extends CertStoreSpi {
    ...
    private static final int CRL_CONNECT_TIMEOUT =
            initializeTimeout("net.tongsuo.pkix.crl.timeout",
    ...
    private static final int CRL_READ_TIMEOUT =
            initializeTimeout("net.tongsuo.pkix.crl.readtimeout",
    ...
    private static int initializeTimeout(String prop, int def) {
        Integer tmp = java.security.AccessController.doPrivileged(
                new GetIntegerAction("net.tongsuo.pkix.crl.timeout"));
        if (tmp == null || tmp < 0) {
            return def;
        }
        if (debug != null) {
