...
import net.tongsuo.pkix.PKIXUtils;
import net.tongsuo.sun.security.provider.X509Factory;
...
import net.tongsuo.sun.security.util.Pem;
...
public class X509CertImpl extends X509Certificate
    ...
    public Set<String> getCriticalExtensionOIDs() {
        ...
        try {
            ...
            for (net.tongsuo.sun.security.x509.Extension ex : exts.getAllExtensions()) {
                if (ex.isCritical()) {
