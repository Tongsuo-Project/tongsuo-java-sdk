...
import net.tongsuo.sun.security.action.GetBooleanAction;
import net.tongsuo.sun.security.x509.GeneralNameInterface;
import net.tongsuo.sun.security.x509.GeneralNames;
import net.tongsuo.sun.security.x509.GeneralSubtrees;
import net.tongsuo.sun.security.x509.NameConstraintsExtension;
import net.tongsuo.sun.security.x509.SubjectAlternativeNameExtension;
...
public abstract class Builder {
    ...
    final static boolean USE_AIA = AccessController.doPrivileged
        (new GetBooleanAction("net.tongsuo.pkix.enableAIAcaIssuers"));
