...
import net.tongsuo.sun.security.action.GetIntegerAction;
...
import net.tongsuo.sun.security.util.HexDumpEncoder;
...
import net.tongsuo.sun.security.x509.Extension;
...
public final class OCSPResponse {
    ...
    private static int initializeClockSkew() {
        ...
        Integer tmp = java.security.AccessController.doPrivileged(
                new GetIntegerAction("net.tongsuo.pkix.ocsp.clockSkew"));
        if (tmp == null || tmp < 0) {
